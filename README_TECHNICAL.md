...
**👉 [CLICK HERE FOR THE SIMPLE USER GUIDE](USER_GUIDE.md) 👈**

If you just want to use the app:
1.  **Mac**: Double-click `start_app.command`.
2.  **Windows**: Double-click `install_and_run.bat`.
3.  Follow the instructions in the [User Guide](USER_GUIDE.md).
