...
function buildPrompt(settings) {
  ...
  // Simple, natural language task description (matches official Anthropic examples)
  let prompt = 'Convert this PDF to a Word document, preserving all formatting and content.';
...
function buildImagePrompt(settings) {
  ...
  let prompt = 'Convert this image to a Word document, extracting all text and preserving formatting.';
