...
/**
 * Build conversion prompt (concise style - trusts docx skill)
 */
function buildPrompt(settings) {
  ...
  // Ultra-concise prompt to minimize tokens and trust the skill
  ...
  if (addPageMarkers) {
    parts.push('Add [Page N] markers at end of sentences after page breaks.');
  }
...
/**
 * Build conversion prompt for images (concise style - trusts docx skill)
 */
function buildImagePrompt(settings) {
  ...
  // Ultra-concise prompt for images
  let parts = ['Convert this image to .docx extracting all text and preserving formatting.'];
